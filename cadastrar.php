...
<body>
   ...
   <center>
   <form action="scadastro.php" method="post">
       <label for="n1">Email: </label><br><br>
       <input type="email" name="e1" id="e1"><br><br><br><br>
       <label for="n2">Senha: </label><br><br>
       <input type="password" name="s1" id="s1"><br><br><br><br>
